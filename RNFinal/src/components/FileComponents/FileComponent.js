        ...
        <View style={{ flexDirection: "column", height: '100%', width: '100%' }}>
            ...
            <View style={{ flexDirection: "row", height: '87%', width: '100%', backgroundColor: '#396371', padding: 20 }}>
                <View style={{ flexDirection: "column", height: '100%', width: '100%', backgroundColor: '#A1C8D2', borderRadius: 20, padding: 5 }}>
                    ...
                    <TextInput style={styles.textRight}>{TipoSangre}</TextInput>
                    <Text style={styles.textLeft}>Edad</Text>
                    <TextInput style={styles.textRight}>{Edad}</TextInput>
                    <Text style={styles.textLeft}>Medicamentos</Text>
                    <TextInput style={styles.textRight}>{Medicamentos}</TextInput>
                    <Text style={styles.textLeft}>Enfermedades Crónicas</Text>
                    <TextInput style={styles.textRight}>{EnfermedadesCronicas}</TextInput>
                    <Text style={styles.textLeft}>Alergias</Text>
                    <TextInput style={styles.textRight}>{Alergias}</TextInput>
                </View>
            </View>
        </View>
    );
